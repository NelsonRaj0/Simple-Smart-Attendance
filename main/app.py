...
app=Flask(__name__,template_folder="C:/Users/nelso/FaceRecognition_main/My_project/main/templates")
app.secret_key="123"

app.config['UPLOAD_FOLDER']="C:/Users/nelso/FaceRecognition_main/My_project/main/static/images/"

detector = MTCNN()
model_path ="C:/Users/nelso/FaceRecognition_main/My_project/main/facenet_keras.h5"
MyFaceNet = load_model(model_path,compile=False)
facenet = keras_facenet.FaceNet('20180402-114759')

#importing trained models
myfile = open("C:/Users/nelso/FaceRecognition_main/My_project/main/data.pkl", "rb")
...
def excel_sheet(output):
    ...
    book.save("C:/Users/nelso/FaceRecognition_main/My_project/main/Excel_Result/stud.xlsx") 
...
df = pd.read_excel(r"C:/Users/nelso/FaceRecognition_main/My_project/main/Excel_Result/stud.xlsx")
...
def table():
    data = pd.read_excel(r"C:/Users/nelso/FaceRecognition_main/My_project/main/Excel_result/stud.xlsx")
